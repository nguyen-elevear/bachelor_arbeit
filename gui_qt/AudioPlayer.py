...
class AudioPlayer(QWidget):
    ...
    def initUI(self, audio_folder):
        ...
        if self.test_type == "filter_pos":
            ...
            definition_label = QLabel(
                "<h2> You will be presented with listening samples of different sound transitions, each is 3 seconds long and NOT looped <u><em>except for the reference</em></u>. </h2>"
