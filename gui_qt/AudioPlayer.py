    ...
    def initUI(self, audio_folder):
        ...
        if self.test_type == "filter_pos":
            ...
            definition_label = QLabel(
                ...
                "<h2> Please rate the listening experience according to this criteria:</h2>"
                "<ul style='font-size: 12pt;'>"
                "<li>How strongly do you feel a sensation that is somewhat similar to a muffled/clogged/blocked ear? Example for this muffled/clogged/blocked ear sensation is when you are in an descending/ascending airplane or high speed elevator</li>"
                "<li>How strongly do you feel dizzyness or a headache?</li>"
                "<li> 10 = Strong Sensation, feel like I need to swallow to pop my ear</li>"
                "<li> 0 = None, just like normal </li>"
                "<li> 5 = The criterias above describe perfectly what I feel</li>"
                "</ul>"
                "<h2> How to interact with the test interface: </h2>"
                "<ul style='font-size: 12pt;'>"
                "<li>Press the corresponding number on the keyboard to switch to the desired sample. You can do this to switch between the sample to compare them with each other</li>"
