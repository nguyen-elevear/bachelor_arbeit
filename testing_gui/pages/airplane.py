...
src_dir = r"C:\Users\LinhNguyen\Desktop\BA_Code\testing_gui\media\airplane"
sound_samples = []
sound_files = {}
save_file = r"C:\Users\LinhNguyen\Desktop\BA_Code\testing_gui\results\airplane.csv"
...
test = ListeningTest("airplane", st.session_state["name"], sound_samples.copy(), src_dir=src_dir)
