...
src_dir = r"C:\Users\LinhNguyen\Desktop\BA_Code\testing_gui\media\car"
sound_samples = []
sound_files = {}
save_file = r"C:\Users\LinhNguyen\Desktop\BA_Code\testing_gui\results\car.csv"
...
test = ListeningTest("car", st.session_state["name"], sound_samples.copy(), src_dir=src_dir)
