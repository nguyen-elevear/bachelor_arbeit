...
src_dir = r"C:\Users\LinhNguyen\Desktop\BA_Code\testing_gui\media\train"
sound_samples = []
sound_files = {}
save_file = r"C:\Users\LinhNguyen\Desktop\BA_Code\testing_gui\results\train.csv"
...
test = ListeningTest("train", st.session_state["name"], sound_samples.copy(), src_dir=src_dir)
